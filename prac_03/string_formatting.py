...
for i, number in enumerate(numbers, 1):
    print(f"Number {i} is {number:5}")  #:5 moves the values to the right 5 times

## 1.1      Use f-string formatting to produce the output:
# 1922 Gibson L-5 CES for about $16,035!
print(f"{year} {name} for about {cost:,.0f}!")  # adds a comma to the cost. 0f removes the decimal places.

## 1.2      Using a for loop with the range function and string formatting,
...
for i in range(0, 151, 50):
    print(f"{i:3}")  # moves all the values to the right hand side
